//
// Generated file, do not edit! Created by opp_msgc 4.3 from modules/messages/AirFrameUWBIR.msg.
//
...
AirFrameUWBIR::AirFrameUWBIR(const char *name, int kind) : MiximAirFrame(name,kind)
{
}

AirFrameUWBIR::AirFrameUWBIR(const AirFrameUWBIR& other) : MiximAirFrame(other)
{
    copy(other);
}
...
AirFrameUWBIRDescriptor::AirFrameUWBIRDescriptor() : cClassDescriptor("AirFrameUWBIR", "MiximAirFrame")
{
}
